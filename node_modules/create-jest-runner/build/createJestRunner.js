...
var _jestWorker2 = _interopRequireDefault(_jestWorker);
  ...
  var BaseTestRunner = function () {
    ...
    _createClass(BaseTestRunner, [{
      ...
      value: function _createInBandTestRun(tests, watcher, onStart, onResult, onFailure, options) {
        ...
        var mutex = (0, _throat2.default)(1);
      ...
      value: function _createParallelTestRun(tests, watcher, onStart, onResult, onFailure, options) {
        ...
        var worker = new _jestWorker2.default(runPath, {
          exposedMethods: ['default'],
          numWorkers: this._globalConfig.maxWorkers,
          forkOptions: { stdio: 'inherit' }
        });

        var mutex = (0, _throat2.default)(this._globalConfig.maxWorkers);
